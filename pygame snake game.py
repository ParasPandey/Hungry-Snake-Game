...
def welcome():
    ...
    while not exit_game:
        ...
        button1(color2, 240, 130, 150, 50, color2, "Start", red, 45, "play")
        button2(color2, 240, 190, 150, 50, color2, "HighScore", red, 35, "highscore")
        button3(color2, 240, 250, 150, 50, color2, "About", red, 45, "about")
        button4(color2, 240, 310, 150, 50, color2, "Exit", red, 45, "exit")
